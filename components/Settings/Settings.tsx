...
export default function Settings({ open, setOpen }: Props) {
	...
	return (
		<Modal open={open} onClose={() => setOpen(false)}>
			<form
				className="min-w-[400px] w-[45vw] bg-white dark:bg-primary dark:text-white flex flex-col items-center gap-y-4 p-6"
			...
			>
				...
				<div className="mb-4 w-full">
					...
					<div className="flex flex-wrap gap-2 justify-center py-1 h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-400 dark:scrollbar-thumb-gray-600">
						{characters &&
